...
public class Instantiation implements CommandLineRunner {	
	...
	public void run(String... args) throws Exception {
		...
		postRepository.deleteAll();
		 ...
		 Post post1 = new Post(null, sdf.parse("21/03/2018"), "Estou fugindo do Batman", "Vou viajar para Gotham City.", joker); 
		 Post post2 = new Post(null, sdf.parse("21/03/2018"), "Cheguei", "Consegui dar fuga", joker);
